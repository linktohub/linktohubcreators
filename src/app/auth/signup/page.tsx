...
const BENEFITS = [
  "Custom storefront live in minutes",
  "Merch, digital products & AI chat",
  "Fan subscriptions & bookings",
    ...
    <div className="min-h-screen bg-[#050508] text-white flex overflow-hidden">
        ...
        <div className="relative space-y-8">
          <div>
            <h2 className="text-3xl font-black mb-3">
              Start monetizing<br />
              <span className="gradient-text">your audience today.</span>
            </h2>
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-12 relative">
        ...
        <div className="w-full max-w-sm relative">
          <div className="mb-8">
            <h1 className="text-3xl font-black mb-2">Create your storefront</h1>
            <p className="text-white/40">Free forever. Set up in 2 minutes.</p>
          </div>
